Inicios de sesión desde diferentes ubicaciones geográficas a una velocidad físicamente imposible, lo que puede indicar el uso de proxies, VPNs o actividad maliciosa.
